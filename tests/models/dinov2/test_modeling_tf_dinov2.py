...
if is_tf_available():
    ...
    from transformers import TFDinov2ForImageClassification, TFDinov2Model
...
class TFDinov2ModelTester:
    ...
    def create_and_check_model(self, config, pixel_values, labels):
        model = TFDinov2Model(config=config)
    ...
    def create_and_check_for_image_classification(self, config, pixel_values, labels):
        ...
        model = TFDinov2ForImageClassification(config)
...
class TFDinov2ModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = TFDinov2ModelTester(self)
    ...
    def test_model_from_pretrained(self):
        model = TFDinov2Model.from_pretrained("google/dinov2-base-patch16-224")
...
@require_tf
@require_vision
class TFDinov2ModelIntegrationTest(unittest.TestCase):
    @cached_property
    ...
    def test_inference_image_classification_head(self):
        model = TFDinov2ForImageClassification.from_pretrained("google/dinov2-base-patch16-224")
