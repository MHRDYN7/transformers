...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTPatchEmbeddings with ViT->Dinov2,ViTConfig->Dinov2Config
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTEmbeddings with ViT->Dinov2,ViTConfig->Dinov2Config
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTSelfAttention with ViT->Dinov2,ViTConfig->Dinov2Config
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTSelfOutput with ViT->Dinov2,ViTConfig->Dinov2Config
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTAttention with ViT->Dinov2,ViTConfig->Dinov2Config
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTIntermediate with ViT->Dinov2,ViTConfig->Dinov2Config
class FlaxDinov2Intermediate(nn.Module):
    config: Dinov2Config
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTOutput with ViT->Dinov2,ViTConfig->Dinov2Config
class FlaxDinov2Output(nn.Module):
    config: Dinov2Config
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTLayer with ViT->Dinov2,ViTConfig->Dinov2Config
class FlaxDinov2Layer(nn.Module):
    ...
    def setup(self):
        ...
        self.intermediate = FlaxDinov2Intermediate(self.config, dtype=self.dtype)
        self.output = FlaxDinov2Output(self.config, dtype=self.dtype)
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTLayerCollection with ViT->Dinov2,ViTConfig->Dinov2Config
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTEncoder with ViT->Dinov2,ViTConfig->Dinov2Config
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTPooler with ViT->Dinov2,ViTConfig->Dinov2Config
class FlaxDinov2Pooler(nn.Module):
    config: Dinov2Config
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTPreTrainedModel with VIT->DINOV2,ViT->Dinov2,vit->dinov2,ViTConfig->Dinov2Config
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTModule with ViT->Dinov2,ViTConfig->Dinov2Config
class FlaxDinov2Module(nn.Module):
    ...
    def setup(self):
        ...
        self.pooler = FlaxDinov2Pooler(self.config, dtype=self.dtype) if self.add_pooling_layer else None
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTModel with ViT->Dinov2
...
class FlaxDinov2ForImageClassificationModule(nn.Module):
    ...
    def setup(self):
        self.dinov2 = FlaxDinov2Module(config=self.config, dtype=self.dtype, add_pooling_layer=False)
...
# Copied from transformers.models.vit.modeling_flax_vit.FlaxViTForImageClassification with ViT->Dinov2
...
FLAX_VISION_CLASSIF_DOCSTRING = """
    ...
    >>> model = FlaxDinov2ForImageClassification.from_pretrained("google/dinov2-base-patch16-224")
